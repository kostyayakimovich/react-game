...
import { clearTime, setTime, setResult } from './timerActions';
...
function TimerContainer({ isWin, isEndTimer, isNewGame, setIsnewGame }) {
  ...
  useEffect(() => {
    if (timerValue === '1' && time >= 60) dispatch(setIsEndTimer(true));
    if (timerValue === '2' && time >= 120) dispatch(setIsEndTimer(true));
